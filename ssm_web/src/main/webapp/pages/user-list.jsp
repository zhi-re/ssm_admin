                            ...
                            <c:forEach items="${userList}" var="user">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/user/findOne?id=${user.id}"
                                           class="btn bg-olive btn-xs">详情</a>
                                        <a href="${pageContext.request.contextPath}/user/managerUserRole?id=${user.id}"
                                           class="btn bg-olive btn-xs">管理角色</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
